...
class Dispersion(tasks.task.Task):
  ...
  def initialize(self, scattering_particles, **options):
    ...
    Args:
      ...
      **disp_plot_info (DispersionPlotInfo): Contains information for
    ...
    self.dispersion_plot_info = options.pop('dispersion_plot_info', sigmond_info.sigmond_info.DispersionPlotInfo())
  ...
  def readConfig(self, **task_options):
    ...
    task_options['dispersion_plot_info'] = sigmond_info.sigmond_info.DispersionPlotInfo.createFromConfig(task_options)
  ...
  def getSigmondInputs(self):
    ...
    for particle_name, fit_infos in self.scattering_particles.items():
      ...
      sigmond_input.doDispersion(
          ...
          plot_info=self.dispersion_plot_info)
